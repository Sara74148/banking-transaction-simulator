...
public class WithdrawForm extends JFrame {
    ...
    private void handleWithdraw() {
        ...
        if (accountInfo.balance < amount) {
            showError(String.format("Insufficient balance. Available balance: %.2f", accountInfo.balance));
            return;
        }
        ...
        if (addTransactionToPendingQueue("Withdraw", accountNumber, "-", amount, accountType)) {
            // Log to history
            ...
            showTransactionQueued("Withdraw", accountNumber, amount, accountType);
            clearForm();
        } else {
